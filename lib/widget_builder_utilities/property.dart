...
import 'package:major_project/widget_builder_utilities/property_helpers/font_style_helper.dart';
import 'package:major_project/widget_builder_utilities/property_helpers/scroll_physics_helper.dart';
import '../components/selecting_text_editing_controller.dart';
import '../pages/add_property_widget_dialog.dart';
...
class CustomDropdownButton extends StatelessWidget {
  ...
  CustomDropdownButton({Key? key, this.items,  this.onChanged, this.value})
      : super(key: key);
